...
function Trip() {
  return (
    <div className="my-16 mx-4 text-gray-700 md:mx-3 ">
      <h1>Our suggested Trip</h1>
      <p className="p">
        All you need to do is follow our suggested itinerary and get ready for
        the trip of a lifetime.
      </p>
      <div className="flex justify-between mt-12 md:flex-col md:w-full  md:my-6 ">
        <TripData
          image={KharUsLake}
